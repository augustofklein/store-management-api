...
namespace StoreManagement.Application.Contracts.Persistence
{
    public interface IProductRepository
    {
        ...
        Task<Result> EditProductAsync(int companyId, int id, bool status, string description, decimal price, CancellationToken cancellationToken);
        Task<Result<ProductPagedResultDto>> GetProductsAsync(int companyId, int pageNumber, int pageSize, CancellationToken cancellationToken);
